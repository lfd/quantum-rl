...
from tfq_models.vqc_layers import Pooling_Layer_Big
...
policy_model = VQC_Model(num_qubits=4, num_layers=3, 
                        ...
                        readout_op=None,
                        pooling_layertype=Pooling_Layer_Big)
target_model = VQC_Model(num_qubits=4, num_layers=3, activation='sigmoid', 
                        scale=Scale(name="scale"), 
                        readout_op=None,
                        pooling_layertype=Pooling_Layer_Big)
