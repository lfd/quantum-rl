...
## Model
policy_model = Full_Param_Cartpole_Model(num_qubits=4, num_layers=3, activation='sigmoid', scale=Scale(name="scale"), pooling='v2')
target_model = Full_Param_Cartpole_Model(num_qubits=4, num_layers=3, activation='sigmoid', scale=Scale(name="scale"), pooling='v2')
