...
from tfq_models.skolik.base_model import Small_VQC_Model
import gym
...
## Model
policy_model = Small_VQC_Model(num_qubits=4, num_layers=5, scale=Scale(name="scale"))
target_model = Small_VQC_Model(num_qubits=4, num_layers=5, scale=Scale(name="scale"))
