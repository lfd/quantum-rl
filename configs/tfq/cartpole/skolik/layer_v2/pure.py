...
## Model
policy_model = VQC_Model(num_qubits=4, num_layers=8, scale=Scale(name="scale"), layertype=VQC_Layer_V2)
target_model = VQC_Model(num_qubits=4, num_layers=8, scale=Scale(name="scale"), layertype=VQC_Layer_V2)
