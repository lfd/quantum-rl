...
from tfq_models.blackjack_model import VQC_Model_Blackjack
import gym
...
## Model
policy_model = VQC_Model_Blackjack(num_qubits=4, num_layers=3, scale=Scale(name="scale"))
target_model = VQC_Model_Blackjack(num_qubits=4, num_layers=3, scale=Scale(name="scale"))
