...
## Model
policy_model = Full_Param_Cartpole_Model(num_qubits=4, num_layers=3, activation='sigmoid', pooling=None, hybrid=True)
target_model = Full_Param_Cartpole_Model(num_qubits=4, num_layers=3, activation='sigmoid', pooling=None, hybrid=True)
