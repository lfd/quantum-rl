...
from tfq_models.lockwood.blackjack_model import VQC_Model_Blackjack
import gym
...
## Model
policy_model = VQC_Model_Blackjack(num_qubits=3, num_layers=3)
target_model = VQC_Model_Blackjack(num_qubits=3, num_layers=3)
